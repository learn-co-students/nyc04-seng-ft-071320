...
# e_mvc = Favorite.create(student: eric, word: mvc, priotity_level: 5)
# e_response = Favorite.create(student: eric, word: response, priotity_level: 3)
# e_request = Favorite.create(student: eric, word: request, priotity_level: 3)
# s_a_s = Favorite.create(student: sylwia, word: angry_squid, priotity_level: 5)
# s_i_c_c = Favorite.create(student: sylwia, word: ice_cream_cone, priotity_level: 5)
# s_i_c_c = Favorite.create(student: sylwia, word: strong_params, priotity_level: 5)
